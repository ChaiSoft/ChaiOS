...
#define _PDCLIB_ULLONG_MAX 0xFFFFFFFFFFFFFFFF
...
#define __INT64_MAX__ __LONG_LONG_MAX__
...
#define __UINT64_MAX__ _PDCLIB_ULLONG_MAX
...
#define __SIG_ATOMIC_TYPE__ __INT64_TYPE__
#define __SIG_ATOMIC_MAX__ __INT64_MAX__
#else
#error "Unrecoginsed Architecture"
#endif
...
#define __WINT_TYPE__     __WCHAR_TYPE__
#define __WINT_MAX__ __WCHAR_MAX__
#define __WINT_MIN__ __WCHAR_MIN__
#define __INTMAX_TYPE__ __INT64_TYPE__
#define __INTMAX_C __INTMAX_TYPE__
...
#define __builtin_va_arg __crt_va_arg
#define __builtin_va_copy(destination, source) ((destination) = (source))
...
//
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
#define __DBL_DECIMAL_DIG__  17                      // # of decimal digits of rounding precision
#define __DBL_DIG__          15                      // # of decimal digits of precision
#define __DBL_EPSILON__      2.2204460492503131e-016 // smallest such that 1.0+DBL_EPSILON != 1.0
#define __DBL_HAS_SUBNORM__  1                       // type does support subnormal numbers
#define __DBL_MANT_DIG__     53                      // # of bits in mantissa
#define __DBL_MAX__          1.7976931348623158e+308 // max value
#define __DBL_MAX_10_EXP__   308                     // max decimal exponent
#define __DBL_MAX_EXP__      1024                    // max binary exponent
#define __DBL_MIN__         2.2250738585072014e-308 // min positive value
#define __DBL_MIN_10_EXP__   (-307)                  // min decimal exponent
#define __DBL_MIN_EXP__      (-1021)                 // min binary exponent
#define __DBL_RADIX__       2                       // exponent radix
#define __DBL_TRUE_MIN__     4.9406564584124654e-324 // min positive value
#define __DBL_DENORM_MIN__   __DBL_TRUE_MIN__

#define __FLT_DECIMAL_DIG__  9                       // # of decimal digits of rounding precision
#define __FLT_DIG__          6                       // # of decimal digits of precision
#define __FLT_EPSILON__      1.192092896e-07F        // smallest such that 1.0+FLT_EPSILON != 1.0
#define __FLT_HAS_SUBNORM__  1                       // type does support subnormal numbers
#define __FLT_GUARD__        0
#define __FLT_MANT_DIG__     24                      // # of bits in mantissa
#define __FLT_MAX__          3.402823466e+38F        // max value
#define __FLT_MAX_10_EXP__   38                      // max decimal exponent
#define __FLT_MAX_EXP__      128                     // max binary exponent
#define __FLT_MIN__          1.175494351e-38F        // min normalized positive value
#define __FLT_MIN_10_EXP__   (-37)                   // min decimal exponent
#define __FLT_MIN_EXP__      (-125)                  // min binary exponent
#define __FLT_NORMALIZE__    0
#define __FLT_RADIX__        2                       // exponent radix
#define __FLT_TRUE_MIN__     1.401298464e-45F        // min positive value
#define __FLT_DENORM_MIN__   __FLT_TRUE_MIN__

#define __LDBL_DECIMAL_DIG__ __DBL_DECIMAL_DIG__         // # of decimal digits of rounding precision
#define __LDBL_DIG__         __DBL_DIG__                 // # of decimal digits of precision
#define __LDBL_EPSILON__     __DBL_EPSILON__             // smallest such that 1.0+LDBL_EPSILON != 1.0
#define __LDBL_HAS_SUBNORM__ __DBL_HAS_SUBNORM__         // type does support subnormal numbers
#define __LDBL_MANT_DIG__    __DBL_MANT_DIG__            // # of bits in mantissa
#define __LDBL_MAX__         __DBL_MAX__                 // max value
#define __LDBL_MAX_10_EXP__  __DBL_MAX_10_EXP__          // max decimal exponent
#define __LDBL_MAX_EXP__     __DBL_MAX_EXP__             // max binary exponent
#define __LDBL_MIN__         __DBL_MIN__                 // min normalized positive value
#define __LDBL_MIN_10_EXP__  __DBL_MIN_10_EXP__          // min decimal exponent
#define __LDBL_MIN_EXP__     __DBL_MIN_EXP__             // min binary exponent
#define __LDBL_RADIX__      __DBL_RADIX__              // exponent radix
#define __LDBL_TRUE_MIN__    __DBL_TRUE_MIN__            // min positive value
#define __LDBL_DENORM_MIN__    __LDBL_TRUE_MIN__            // min positive value
#define __STDC__ 1

#define PDCLIB_SUPPRESS_INTRINSIC(x) __pragma(function(x))
#else
#define PDCLIB_SUPPRESS_INTRINSIC(x)
#endif
...
/* compiler states about __LDBL_MANT_DIG__ to determine the type.                 */
...
#elif defined( __x86_64 ) || defined( __arm__ ) || defined( __ARM_NEON )  || defined(X64)
